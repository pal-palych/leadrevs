                ...
                <form onSubmit={loginUser}>
                  <div className="-mx-4 flex flex-wrap">
                        ...
                        <div className="flex flex-wrap gap-4">
                          <div className="mr-10 mb-4">
                            <label
                              ...
                              className="text-body-color hover:text-primary flex cursor-pointer select-none"
                            >
                              <div className="relative">
                                <input
                                  ...
                                  className="sr-only"
                                />
                                <div className="box mt-0.5 mr-4 flex h-5 w-5 items-center justify-center rounded-sm border">
                    ...
                    <div className="w-full px-4">
                      <button
                        type="submit"
                        className="bg-primary hover:bg-primary/90 flex items-center justify-center rounded-sm px-14 py-[14px] text-sm font-semibold text-white"
                      >
                        Sign In Now
                      </button>
                    </div>
