...
const CodeWithCopy = ({ code }: any) => {
  ...
  return (
    ...
    >
      ...
      {/*@ts-ignore*/}
      <Clipboard
        className={`bg-stroke hover:border-primary hover:bg-primary dark:hover:bg-primary absolute top-2 right-2 z-10 flex h-9 cursor-pointer items-center justify-center rounded-lg border border-solid px-5 text-sm text-black duration-300 hover:text-white dark:bg-white ${
